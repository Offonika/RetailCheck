...
- **Согласованные whitelist-правила.**
  - Магазин 1: `@Zuuuuhra99`, `@o_lisaaaa` + резерв `@Asad_lkaev`; могут подменять смены магазина 2.
  - Магазин 2: `@a1III11`, `@VviVkk`, `@offonar`; при необходимости закрывают смены магазина 1.
